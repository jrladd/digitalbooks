...
- [EarlyPrint Corpus Search](hhttps://eplab.artsci.wustl.edu/blacklab-frontend/earlyprint/search/)
...
1. Follow the tutorials in the [EarlyPrint + Python](https://earlyprint.org/jupyterbook/intro.html) notebooks, especially the Word Embeddings and Unsupervised Clustering exercises.
